...
/*
 Title: Running Keras models on iOS with CoreML
 Author: Adrian Rosebrock
 Date: 23 April 2018
 Code version: 1.0
 Availability: https://www.pyimagesearch.com/2018/04/23/running-keras-models-on-ios-with-coreml/
*/
...
class ThirdViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    override func viewDidLoad() {
        ...
        //start capture session and add label
        setupCaptureSession()
    ...
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        guard let model = try? VNCoreMLModel(for: aligned_nba52_u().model) else { return }
